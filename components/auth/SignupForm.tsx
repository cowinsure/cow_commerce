...
export function SignupForm({ className }: { className?: string }) {
  ...
  const onSubmit = async (data: SignupFormData) => {
    ...
    try {
      ...
      // First, register with mobile number
    ...
    return new Promise((resolve) => {
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(
          ...
          () => {
            // Default to Dhaka coordinates if geolocation fails
            resolve({
              latitude: 23.8103,
              longitude: 90.4125,
            });
        ...
        // Default to Dhaka coordinates if geolocation is not supported
        resolve({
          latitude: 23.8103,
          longitude: 90.4125,
        });
      ...
      >
        ...
        <div className="flex items-center gap-2 py-2 group">
          <div className="relative w-5 h-5 flex items-center justify-center">
            ...
            <div
              className="w-5 h-5 rounded-md border-2 border-gray-300 bg-white 
            ...
            <svg
              className="absolute w-6 h-6 text-green-600 opacity-0 peer-checked:opacity-100 
        ...
        <button
          ...
          className={cn(
            "w-full h-12 rounded-xl bg-green-700 text-white font-semibold text-sm",
            "transition-all duration-200 ease-out",
        ...
        {/* <div className="relative flex items-center py-4">
          <div className="grow border-t border-gray-200/30" />
          <span className="shrink mx-4 text-xs font-bold text-gray-400 uppercase tracking-widest">
            or continue with
          </span>
          <div className="grow border-t border-gray-200/30" />
        </div> */}
        ...
        {/* <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="flex items-center justify-center gap-3 h-12 bg-white border border-gray-200 rounded-full hover:bg-gray-50 transition-all text-sm font-semibold text-gray-700"
          >
