...
export default function TermsPage({
  ...
  return (
    ...
    >
      ...
      {/* ─── Hero ───────────────────────────────────────── */}
      <header className="relative overflow-hidden min-h-[60vh] md:min-h-[70vh] flex items-center">
        {/* Background Image */}
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-24 md:py-32">
          ...
          >
            ...
            <motion.div
              variants={itemVariants}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-emerald-100 text-sm font-medium mb-8"
            >
            ...
            <motion.h1
              variants={itemVariants}
              className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight mb-6 text-white"
            >
              {t("terms_hero_title")}
            </motion.h1>
            ...
            <motion.div
              variants={itemVariants}
              className="mt-10 w-24 h-[2px] bg-emerald-400/60 rounded-full"
            />
          </motion.div>
        </div>
      </header>
      ...
      {/* ─── Sticky Nav ─────────────────────────────────── */}
      {!hideNavigation && (
        <nav className="sticky top-20 z-30 bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-sm">
      ...
      <main className="max-w-screen-2xl mx-auto px-6 py-12 space-y-16">
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-white mb-2">
            FreshBuy নির্বাচন করার জন্য আপনাকে ধন্যবাদ
          </h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <SubSection title="১.২ মাংস প্রক্রিয়াজাতকরণ ও ডেলিভারি সময়সূচি (খাদ্য নিরাপত্তা মানসম্মত)">
        <BulletList
          items={[
            ...
            "ঈদের ৫ম দিন (Eid Day +5) থেকে পরবর্তী ডেলিভারির ক্ষেত্রে, FreshBuy কার্যক্রমগত সক্ষমতার ভিত্তিতে প্রক্রিয়াজাতকরণ, সংরক্ষণ এবং পরিবহনের পুরো সময়জুড়ে মাংসকে নিয়ন্ত্রিত কোল্ড চেইন (০°সে থেকে ৪°সে) এর মধ্যে সংরক্ষণের ব্যবস্থা করবে।",
            "পণ্য নিরাপত্তা, স্বাস্থ্যবিধি এবং গুণগত মান বজায় রাখতে FreshBuy ইনসুলেটেড, ফুড-গ্রেড প্যাকেজিং এবং রেফ্রিজারেটেড পরিবহন ব্যবস্থা ব্যবহার করবে।",
      ...
      <SubSection title="১.৩ বুকিং ও পেমেন্ট">
        <BulletList
          items={[
            ...
            "অবশিষ্ট ৫০% অর্থ বুকিংয়ের সময় FreshBuy কর্তৃক নির্ধারিত সময়সীমার মধ্যে পরিশোধ করতে হবে।",
            ...
            "এক্ষেত্রে অগ্রিম প্রদত্ত অর্থ সম্পূর্ণরূপে অ-ফেরতযোগ্য হিসেবে বাজেয়াপ্ত হবে এবং FreshBuy উক্ত গরুটি অন্য গ্রাহকের কাছে পুনরায় বরাদ্দ করার অধিকার সংরক্ষণ করে।",
          ]}
        />
          ...
          <div className="space-y-4 text-sm">
            <div>
              ...
              <span className="text-amber-800">
                ...
                সম্পূর্ণ অর্থ পরিশোধ না করা পর্যন্ত নিশ্চিত নয়। FreshBuy
            ...
            <div>
              ...
              <span className="text-amber-800">
                ...
                হলে, FreshBuy চূড়ান্ত পেমেন্টের সময় প্রচলিত গরুর বাজারদর,
            ...
            <div>
              ...
              <span className="text-amber-800">
                ...
                নির্ভরশীল। FreshBuy কর্তৃক জানানো যেকোনো সংশোধিত মূল্য চূড়ান্ত
      ...
      <SubSection title="১.৬ ঐচ্ছিক ভুঁড়ি সংগ্রহ (ব্যাখ্যা)">
        ...
        <BulletList
          items={[
            ...
            "এই বিকল্প নির্বাচন করা হলে, ভুঁড়ি আলাদাভাবে সংরক্ষণ, প্যাকেজিং এবং নির্ধারিত FreshBuy আউটলেট থেকে সংগ্রহের জন্য উপলব্ধ করা হবে।",
      ...
      <SubSection title="১.৭ চামড়ার মূল্য ও মালিকানা ধারা">
        ...
        <div className="space-y-4 mt-4">
          <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <BulletList
              items={[
                "লিখিতভাবে ভিন্ন কোনো চুক্তি না থাকলে, জবাই ও প্রক্রিয়াজাতকরণের পর চামড়া সম্পূর্ণরূপে FreshBuy-এর মালিকানাধীন থাকবে।",
          ...
          <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <BulletList
              items={[
                ...
                "FreshBuy সামগ্রিক সেবামূল্য কাঠামোর অংশ হিসেবে প্রক্রিয়াজাতকরণ, লজিস্টিকস বা অন্যান্য সেবার খরচের সাথে চামড়ার মূল্য সমন্বয়, সমন্বিতকরণ বা অফসেট করার অধিকার সংরক্ষণ করে।",
          ...
          <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <BulletList
              items={[
                ...
                "বর্তমান বাজার পরিস্থিতি প্রতিফলিত করতে FreshBuy পূর্ব নোটিশ ছাড়াই সময়ে সময়ে চামড়ার মূল্য সংশোধন করতে পারে।",
              ]}
            />
          </div>
          ...
          <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
            ...
            <BulletList
              items={[
                "FreshBuy কর্তৃক স্বাক্ষরিত লিখিত চুক্তিতে স্পষ্টভাবে উল্লেখ না থাকলে, গ্রাহক চামড়ার মূল্য সম্পর্কিত কোনো পৃথক মালিকানা দাবি, অর্থ ফেরতের দাবি বা আর্থিক অধিকার দাবি করতে পারবেন না।",
              ]}
            />
          </div>
        </div>
      ...
      <SubSection title="১.৮ ডেলিভারি শর্তাবলি">
        <BulletList
          items={[
            ...
            "রেফ্রিজারেটেড যানবাহনের জন্য প্রবেশপথ অনিরাপদ, সীমাবদ্ধ বা কার্যত অযোগ্য মনে হলে FreshBuy সরাসরি বাসায় ডেলিভারি প্রত্যাখ্যান করার অধিকার সংরক্ষণ করে।",
            "এমন ক্ষেত্রে, FreshBuy-এর লজিস্টিকস টিমের নির্ধারণ অনুযায়ী ঢাকা শহরের মধ্যে নিকটতম নিরাপদ ও প্রবেশযোগ্য সড়কপথ বা নির্ধারিত ড্রপ-অফ পয়েন্টে ডেলিভারি সম্পন্ন করা হবে।",
          ]}
        />
        ...
        <div className="mt-4 p-5 bg-red-50 border border-red-200 rounded-xl">
          ...
          <div className="space-y-3 text-sm text-red-800">
            <p>
              ...
              বিঘ্নের জন্য FreshBuy দায়ী থাকবে না:
            </p>
      ...
      <SubSection title="১.৯ পশুর স্বাস্থ্য ও প্রতিস্থাপন">
        <BulletList
          items={[
            "নির্বাচিত কোনো গরু যদি অনুপযুক্ত, অসুস্থ, রোগাক্রান্ত বা FreshBuy-এর স্বাস্থ্য ও মান নিয়ন্ত্রণ মানদণ্ড পূরণে ব্যর্থ বলে প্রতীয়মান হয়, তবে FreshBuy প্রয়োজনীয় সংশোধনমূলক ব্যবস্থা গ্রহণের অধিকার সংরক্ষণ করে।",
            "FreshBuy অযৌক্তিক বিলম্ব ছাড়াই গ্রাহককে অবহিত করবে এবং প্রয়োজনে পশুর অবস্থা সম্পর্কিত প্রাসঙ্গিক তথ্য প্রদান করবে।",
            "প্রাপ্যতা ও কার্যগত সক্ষমতা সাপেক্ষে, FreshBuy সমমানের গুণগত মান, ওজনসীমা ও মূল্যের একটি বিকল্প পশুর ব্যবস্থা করবে।",
            "পশু প্রতিস্থাপনের সিদ্ধান্ত FreshBuy-এর প্রাণিস্বাস্থ্য মূল্যায়ন ও গুণগত নিশ্চয়তা নীতিমালা অনুযায়ী গৃহীত হবে এবং সেবা ধারাবাহিকতার স্বার্থে তা চূড়ান্ত বলে বিবেচিত হবে।",
          ]}
        />
      </SubSection>
      ...
      <SubSection title="১.১০ ফোর্স মেজর">
        <BulletList
          items={[
            "FreshBuy-এর যৌক্তিক নিয়ন্ত্রণের বাইরে সংঘটিত কোনো ঘটনার (ফোর্স মেজর) কারণে দায়িত্ব পালনে বিলম্ব, বিঘ্ন, স্থগিতাদেশ বা ব্যর্থতার জন্য FreshBuy দায়ী থাকবে না।",
            ...
            "ফোর্স মেজর পরিস্থিতিতে FreshBuy প্রয়োজন অনুসারে ডেলিভারির সময়সূচি স্থগিত, পুনঃনির্ধারণ বা পরিবর্তন করতে পারে।",
            "ডেলিভারি সময়সূচিতে কোনো গুরুত্বপূর্ণ পরিবর্তন হলে FreshBuy যত দ্রুত সম্ভব গ্রাহককে অবহিত করার যুক্তিসঙ্গত প্রচেষ্টা করবে।",
            "এ ধরনের বিলম্ব বা পরিবর্তন চুক্তিভঙ্গ হিসেবে গণ্য হবে না এবং এর ফলে সৃষ্ট ক্ষতি, বিলম্ব বা অসুবিধার জন্য FreshBuy কোনো দায় বহন করবে না।",
          ]}
        />
      </SubSection>
      ...
      <SubSection title="১.১১ ডেলিভারি গ্রহণ">
        <BulletList
          items={[
            ...
            "পরিদর্শনের পর ডেলিভারি গ্রহণ করা হলে অর্ডার চূড়ান্ত বলে গণ্য হবে এবং FreshBuy কর্তৃক নির্ধারিত প্রমাণিত গুরুতর অবহেলা ব্যতীত কোনো দাবি, বিরোধ, আপত্তি বা ক্ষতিপূরণের অনুরোধ গ্রহণযোগ্য হবে না।",
          ]}
        />
      </SubSection>
        ...
        <div className="p-5 bg-red-50 border border-red-200 rounded-xl">
          <BulletList
            items={[
              ...
              "অর্ডার নিশ্চিত হওয়ার পর কোনো অবস্থাতেই অর্থ ফেরত, চার্জব্যাক বা বাতিলের অনুরোধ গ্রহণযোগ্য হবে না, যদি না FreshBuy ব্যবস্থাপনা লিখিতভাবে অন্যথা সম্মতি প্রদান করে।",
            ]}
          />
        </div>
      </SubSection>
      ...
      <SubSection title="২.৩ ডেলিভারি ও সংগ্রহ">
        <BulletList
          items={[
            ...
            "গ্রাহককে ঢাকা শহরের মধ্যে নির্ধারিত FreshBuy সংগ্রহ কেন্দ্র থেকে তার অংশ সংগ্রহ করতে হবে।",
      ...
      <SubSection title="৩.২ ডেলিভারি শর্তাবলি">
        <BulletList
          items={[
            ...
            "প্রবেশপথ সীমাবদ্ধ হলে, FreshBuy-এর লজিস্টিকস টিমের সিদ্ধান্ত অনুযায়ী নিকটতম নিরাপদ ও প্রবেশযোগ্য স্থানে ডেলিভারি সম্পন্ন করা হবে।",
          ]}
        />
      </SubSection>
    ...
    <div className="space-y-4">
      <BulletList
        items={[
          ...
          "অপারেশনাল সীমাবদ্ধতা, লজিস্টিক জটিলতা বা বাহ্যিক কারণে ডেলিভারি সময়সূচি পরিবর্তন বা সমন্বয় করার অধিকার FreshBuy সংরক্ষণ করে।",
