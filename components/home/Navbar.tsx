...
export function Navbar({ className }: { className?: string }) {
  ...
  return (
    <nav className={cn('fixed top-0 w-full z-50 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl', className)}>
      <div className="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          <button className="px-5 py-2 text-sm font-semibold text-emerald-900 dark:text-emerald-500 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-all duration-200">
            Login
          </button>
