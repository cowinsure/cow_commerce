    ...
    <>
      ...
      <div className="lg:hidden w-full mb-4">
        <motion.button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white/80 backdrop-blur-xl border border-white/50 rounded-2xl shadow-lg text-emerald-600 font-semibold"
        >
      ...
      <motion.aside
        ...
        initial="hidden"
        animate="visible"
        className={cn("hidden lg:block col-span-3 space-y-6", className)}
      >
        ...
        {mobileFilterOpen && (
          <>
            ...
            <motion.div
              ...
              className="lg:hidden fixed inset-x-0 bottom-0 h-[70dvh] bg-white z-50 overflow-y-auto rounded-t-3xl"
            >
              <div className="p-4">
                ...
                {/* Filter Content - Same as desktop but without the aside wrapper */}
                <div className="space-y-6">
                  <div className="relative rounded-3xl bg-white/80 backdrop-blur-xl border border-white/50 shadow-xl">
                    <div className="p-4">
                      {/* Header */}
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-2">
